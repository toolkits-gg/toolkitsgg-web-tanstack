...
import { AMULETS } from "#/games/remnant2/item-data/amulets";
import { ARCHETYPES } from "#/games/remnant2/item-data/archetypes";
import { ARMORS } from "#/games/remnant2/item-data/armors";
import { CONCOCTIONS } from "#/games/remnant2/item-data/concoctions";
import { CONSUMABLES } from "#/games/remnant2/item-data/consumables";
import { FUSIONS } from "#/games/remnant2/item-data/fusions";
import { MODS } from "#/games/remnant2/item-data/mods";
import { MUTATORS } from "#/games/remnant2/item-data/mutators";
import { PERKS } from "#/games/remnant2/item-data/perks";
import { PRISMS } from "#/games/remnant2/item-data/prisms";
import { PYLONS } from "#/games/remnant2/item-data/pylons";
import {
	RELIC_FRAGMENTS,
	type Remnant2RelicFragmentItem,
} from "#/games/remnant2/item-data/relic-fragments";
import { RELICS } from "#/games/remnant2/item-data/relics";
import { RINGS } from "#/games/remnant2/item-data/rings";
import { SKILLS } from "#/games/remnant2/item-data/skills";
import { TRAITS } from "#/games/remnant2/item-data/traits";
import { WEAPONS } from "#/games/remnant2/item-data/weapons";
